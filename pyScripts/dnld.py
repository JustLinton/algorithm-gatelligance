...
def save_data(audio_url):
    ...
    # with open("./tmp/"+file_name + ".mp3", "wb") as f:
    with open(sys.argv[1], "wb") as f:
        f.write(audio_data)
    # with open("./tmp/"+file_name + ".mp4", "wb") as f:
    #     f.write(video_data)


html_data = send_request(sys.argv[2]).text
video_data = get_video_data(html_data)
save_data(video_data[1])
